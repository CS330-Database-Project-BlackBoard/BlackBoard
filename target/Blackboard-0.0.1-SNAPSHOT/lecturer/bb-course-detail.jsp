		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a
						href="${pageContext.request.contextPath}/admin/managers"><i
							class="fa fa-user"></i> User Management</a></li>
					<li><a class="active-menu"
						href="${pageContext.request.contextPath}/admin/courses"><i
							class="fa fa-book"></i> Course Management</a></li>
					<li><a
						href="${pageContext.request.contextPath}/admin/students"><i
							class="fa fa-graduation-cap"></i> Student Management</a></li>

					<li><a class=""
						href="${pageContext.request.contextPath}/admin/lecturers"><i
							class="fa fa-users"></i> Lecturer Management</a></li>
					<li><a
				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							<%= lectureDashboard.getCourse().getName() %>
							Course Detail
						</h1>
					</div>
				</div>
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div
									class="panel panel-primary text-center no-boder bg-color-dgray">
									...
									<div class="panel-footer back-footer-dgray">
										<a class="white-link"
											href="${pageContext.request.contextPath}/admin/lecture/<%=lectureDashboard.getLectureID()%>/grades">
											Grades</a>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div
									class="panel panel-primary text-center no-boder bg-color-dblue">
									<div class="panel-body">
									...
									<div class="panel-footer back-footer-dblue">
										<a class="white-link"
											href="${pageContext.request.contextPath}/admin/lecture/<%=lectureDashboard.getLectureID()%>/students">Students</a>
									</div>
								</div>
							</div>
						</div>
